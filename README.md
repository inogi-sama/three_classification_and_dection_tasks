...
**The complete implementation and corresponding results can be found via the link below:**[three_classification_and_dection_tasks/src/task2_metastasis.py at master · inogi-sama/three_classification_and_dection_tasks · GitHub](https://github.com/inogi-sama/three_classification_and_dection_tasks)
...
![Task 1 ROC Curve](roc_curve_plot.png)
